...
public class Program {
    public static void main(String[] args) {
        ...
        CadastroProfissional profissional1 = new CadastroProfissional(
                "Dr. João Silva", "15/04/1980", "123.456.789-00", "Rua A, 123",
        ...
        CadastroProfissional profissional2 = new CadastroProfissional(
                "Dra. Ana Costa", "10/11/1975", "555.666.777-88", "Rua C, 789",
        ...
        CadastroProfissional encontrado = banco.buscarProfissionalPorId(profissional1.getId());
        if (encontrado != null) {
        ...
        CadastroProfissional inexistente = banco.buscarProfissionalPorId(99999);
        if (inexistente == null) {
